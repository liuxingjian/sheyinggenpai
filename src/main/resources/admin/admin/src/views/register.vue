  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="工号" class="input" v-if="tableName=='sheyingshi'">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='sheyingshi'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="员工姓名" class="input" v-if="tableName=='sheyingshi'">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='sheyingshi'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.gonghao) && `sheyingshi` == this.tableName){
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `sheyingshi` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.yuangongxingming) && `sheyingshi` == this.tableName){
      ...
      if(`sheyingshi` == this.tableName && this.ruleForm.lianxishouji&&(!this.$validate.isMobile(this.ruleForm.lianxishouji))){
